...
class TestTransaction(TestCase):
    ...
    def test_json(self):
        ...
        transaction = Transaction(0, 0, 0, 10, datetime.date(2023, 2, 17), False, "test", "Alice", "Bob")
    ...
    def test_build_from_id(self):
        ...
        expect = Transaction(1, 1, 2, 10, datetime.date(2023, 2, 17), False, "test", "Bob _", "Alice _")

        # connect to db
        conn = mysql.connector.connect(host="localhost", user="root", password="HALR0b0t!12", database="x5db")
        db = conn.cursor()
